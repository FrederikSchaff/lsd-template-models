...
#include "lsd-modules/PajekFromCpp/PajekFromCpp_head.h" //export to .net and .paj format
...
*/
    ...
    MAKE_UNIQUE("Agent");
    MAKE_UNIQUE("Patch");
    PAJ_INIT_ANIM("Pajek",CONFIG,RND_SEED,CONFIG);
  #endif
  ...
  //Initialse the agents
    ...
    #endif
  	ADDNOBJL("Agent", nAgents -1,0); //add missing number of agents to the SPACE - same place as other agents.
